...
from langchain.llms.GoogleGenerativeAI import GoogleGenerativeAI
...
GoogleGenerativeAI_api_key = st.sidebar.text_input("Gemini API Key", type="password")
if not GoogleGenerativeAI_api_key:
    st.error("Please enter your GoogleGenerativeAI API key.")
    st.stop()

llm = ChatGoogleGenerativeAI(GoogleGenerativeAI_api_key=GoogleGenerativeAI_api_key, temperature=0, streaming=True)
